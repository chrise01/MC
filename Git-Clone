https://github.com/chrise01/MC.git



# - Dropped the --tag??
MC-1
docker build  https://github.com/chrise01/MC/MC-1/Dockerfile.git -t bedrock-1.18 .
...
#
docker run -d -it -p 192.168.10.39:19132:19132/udp --mount source=bedrock-server-1.18-data-2,target=/minecraft-server-data bedrock-1.18
